//! Public contract tests for the explainability store.
//!
...
//! the Version 1 business invariants that the future SQLite implementation
//! must also satisfy.
...
use graphloom::explainability::{
    ...
    ExplainabilitySpanId, ExplainabilityStore, ExplainabilityStoreError,
    InMemoryExplainabilityStore, MAX_EVENT_QUERY_LIMIT, MAX_RUN_QUERY_LIMIT, RunCompletion,
    RunListCursor, RunQuery, RunStarted,
};
...
fn span_id(value: &str) -> ExplainabilitySpanId {
...
fn envelope_with_sequence(id: ExplainabilityRunId, sequence: u64) -> ExplainabilityEnvelope {
    envelope(id, sequence, timestamp(1, 10))
}

async fn stored_events(
    store: &InMemoryExplainabilityStore,
    id: &ExplainabilityRunId,
...
#[tokio::test]
async fn test_should_enforce_query_limits() -> TestResult {
