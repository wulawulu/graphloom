...
import { GraphDetailSheet } from "@/components/graph/graph-detail"

afterEach(cleanup)

const common = { loading: false, error: false, onOpenChange: vi.fn(), onFocusEntity: vi.fn(), onFocusRelationship: vi.fn() }

describe("GraphDetailSheet", () => {
  it("renders structured entity detail, collapses long sources, and focuses explicitly", async () => {
    ...
    render(<GraphDetailSheet {...common} onFocusEntity={onFocusEntity} detail={{ kind: "entity", value: entity }} />)
  ...
  it("renders relationship direction and focus action", async () => {
    ...
    render(<GraphDetailSheet {...common} onFocusRelationship={onFocusRelationship} detail={{ kind: "relationship", value: relationship }} />)
  ...
  it("renders community hierarchy and a safe formatted report", () => {
    ...
    render(<GraphDetailSheet {...common} detail={{ kind: "community", value: community, report }} />)
